...
public class HelloYouProject{
	
	// Create a class variable of a Scanner objects to allow user input to console
	...
	//This is a method or function (Component that make up the method form a method signature)
	...
	public static void outputUserDetails(String name){
		...
		for (int i = userVars.length -1; 1 > 0; i--){
